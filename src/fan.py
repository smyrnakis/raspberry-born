...
while True:
    ...
    if now.hour >= 0 and now.hour < 8:
        ...
        if temp > 50:
            fan_duty = 100 if temp > 70 else \
                       ...
                       70 if temp > 50 else \
                       50
        # Otherwise, reduce all duty cycles
        else:
            fan_duty = 80 if temp > 70 else \
                       70 if temp > 60 else \
                       50 if temp > 50 else \
                       35 if temp > 40 else \
                       15 if temp > 35 else \
    ...
    # Log temperature and fan duty cycle to syslog every 15 minutes
    if now.minute % 15 == 0 and allowLog == True:
